...
class Phantom_Wan_S2V:
    ...
    def __init__(
        ...
        """
        logging.info(f"I am here inside Phantom_Wan_S2V {phantom_ckpt}")
        ...
        logging.info(f"t5_cpu {self.t5_cpu}")
        logging.info(f"device {self.device}")
        self.num_train_timesteps = config.num_train_timesteps
        self.param_dtype = config.param_dtype
        logging.info(f"num_train_timesteps {self.num_train_timesteps}")
        logging.info(f"param_dtype {self.param_dtype}")
    ...
    def generate(self,
        ...
        """
        # preprocess
        logging.info("I am here inside generate...")
        ...
        logging.info(f"I am here inside generate - target_shape {target_shape}")
        seq_len = math.ceil((target_shape[2] * target_shape[3]) /
                            (self.patch_size[1] * self.patch_size[2]) *
                            target_shape[1] / self.sp_size) * self.sp_size
        logging.info(f"I am here inside generate - seq_len {seq_len}")
        if n_prompt == "":
            n_prompt = self.sample_neg_prompt
        logging.info(f"n_prompt -  {n_prompt}")
